...
<section>
  ...
  <div class="login_form"><!--수직수평정렬용-->
	...
	<form action="<c:url value='/user/find/pw' />" method="POST">
	    <div class="form-floating">
	      <input type="text" class="form-control" id="email" placeholder="ex)name@example.com" name="email">
    	...
    	<div class="d-grid gap-2">
	      <a class="btn btn-primary login" href="<c:url value='/login/main' />" 
	      >로그인페이지 이동</a>
	    </div>
