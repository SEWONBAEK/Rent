...
<section>
  <div class="login_form"><!--수직수평정렬용-->
    ...
    <form action="<c:url value="/user/join/agree" />" method="post" onsubmit="return termscheckFn();">
	...
	<div class="accordion" id="accordionExample">		
		<div class="accordion-item">
		  <h2 class="accordion-header d-flex align-items-center">
		  	<input class="form-check-input me-2" type="checkbox" name="terms" value="6" id="termsover0">
		...
		<div class="accordion-item">
		  <h2 class="accordion-header d-flex align-items-center">
		  	<input class="form-check-input me-2" type="checkbox" name="terms" value="1" id="termsover1">
		...
		<div class="accordion-item">
		  <h2 class="accordion-header d-flex align-items-center">
		  	<input class="form-check-input me-2" type="checkbox" name="terms" value="2" id="termsover2">
		...
		<div class="accordion-item">
		  <h2 class="accordion-header d-flex align-items-center">
		  	<input class="form-check-input me-2" type="checkbox" name="terms" value="3" id="termsover3">
		...
		<div class="accordion-item">
		  <h2 class="accordion-header d-flex align-items-center">
		  	<input class="form-check-input me-2" type="checkbox" name="terms" value="4" id="termsover4">
		...
		<div class="accordion-item">
		  <h2 class="accordion-header d-flex align-items-center">
		  	<input class="form-check-input me-2" type="checkbox" name="terms" value="5" id="termsover5">
    ...
    <div class="d-grid gap-2">
   		<button class="btn btn-primary " type="submit" style="height:50px; margin-top:20px;">다음</button>
    </div>
    </form>
  </div>
</section>
