			...
			<table class="table">
                ...
                <tbody>
                	<c:forEach items="${myPosts}" var="myPosts">
					    <tr>
					        <td>${myPosts.wdate}</td><!-- 질문 링크를 걸어야 합니다(링크주소를모름) -->
					        <td><a href="${pageContext.request.contextPath}/user/mypage/question/${myPosts.noticeNo}">${myPosts.title}</a></td>
       		...
       		<button class="btn btn-primary" type="button" 
				onclick="location.href='${pageContext.request.contextPath}/customer/question'">문의작성</button>
        </div>
