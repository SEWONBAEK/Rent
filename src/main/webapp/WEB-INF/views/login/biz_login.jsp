  ...
  <div class="login_form"><!--수직수평정렬용-->
    ...
    <form method="post" id="inputform"> <!--이메일과 비밀번호 전송할 주소를 지정해야 합니다-->
      <div class="form-floating form-field">
        <input type="email" class="form-control" id="email" placeholder="이메일 주소 입력" name="email">
        <label for="email">이메일 주소 입력</label>
        <span id="emailspan" style="display:inline-block;"></span>
      </div>

      <div class="form-floating">
          <input type="password" class="form-control" id="password" placeholder="비밀번호 입력" name="pw">
    ...
    <div class="mx-auto py-3">
      <p class="my-0 mx-auto text-center "><a href="<c:url value='/biz/biz_account_find/biz_email_find' />" class="mx-auto text-center link-secondary link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover">비즈니스 회원 아이디 찾기</a></p><!--아이디 찾기 링크를 걸어야 합니다-->
      <p class="my-0 text-center"><a href="<c:url value='/biz/biz_account_find/biz_password_find' />" class="my-0 link-secondary link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover">비즈니스 회원 비밀번호 찾기</a></p><!--비밀번호 찾기 링크를 걸어야 합니다-->
