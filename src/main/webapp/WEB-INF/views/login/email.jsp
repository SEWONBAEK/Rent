...
<section>
  <div class="login_form"><!--수직수평정렬용-->
    ...
    <form onsubmit="return loginFn()" action="${pageContext.request.contextPath}/login/email" method="POST" > <!--이메일과 비밀번호 전송할 주소를 지정해야 합니다-->
      ...
      <div class="d-grid gap-2"><!--버튼-->
        <button class="btn btn-primary " type="submit" style="height:50px;" onclick="loginFn()">로그인</button><!--이메일과 비밀번호를 전송할 버튼-->
      </div>
    </form>
